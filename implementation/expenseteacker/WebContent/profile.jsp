						...
						<div class="form-group">
							...
							<div class="cols-sm-10">
								<div class="input-group">
								    ...
								    <input type="text" class="form-control" name="name" id="name" value="<%=u1%>"  placeholder="Enter your Name"/>
								</div>
							</div>
						</div>
							...
							<div class="cols-sm-10">
								<div class="input-group">
									<span class="input-group-addon"><i class="fa fa-cogs" aria-hidden="true"></i></span>
									 <input type="text" class="form-control" name="age" id="age"  value="<%=u2%>"  placeholder="Enter your age"/>
								</div>
							</div>
							...
							<div class="cols-sm-10">
								<div class="input-group">
									<span class="input-group-addon"><i class="fa fa-mobile " aria-hidden="true"></i></span>
									 <input type="text" class="form-control" name="mobileno" id="mobileno" id="mobileno" value="<%=u3%>" placeholder="Enter your mobile no"/>
								</div>
							</div>
						</div>
							...
							<div class="cols-sm-10">
								...
								<div class="input-group">
									<!--  --><span class="input-group-addon"><i class="fa fa-venus-mars" aria-hidden="true"></i></span>
										 <input type="text" class="form-control" name="gender" id="gender" value="<%=u4%>"  placeholder="Enter your gender"/>
								</div>
							</div>
						</div>
						<center>
